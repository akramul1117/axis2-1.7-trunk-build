...
public class Withdraw implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":withdraw", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "withdraw", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static Withdraw parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Withdraw object = new Withdraw();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"withdraw".equals(type)) {
                            ...
                            return (Withdraw) example.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://example", "amount").equals(
                            reader.getName())) ||
